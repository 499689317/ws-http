...
function getDbUrl() {
    var url = "mongodb://" +
            ...
            g_cfg.dev_db.name;
    // var url = "mongodb://" +
    //         // g_cfg.dev_db.username + ":" + g_cfg.dev_db.password + "@" +
    //         g_cfg.dev_db.rs0.host + ":" + g_cfg.dev_db.rs0.port + "," +
    //         g_cfg.dev_db.rs1.host + ":" + g_cfg.dev_db.rs1.port + "," +
    //         g_cfg.dev_db.rs2.host + ":" + g_cfg.dev_db.rs2.port + "/" +
    //         g_cfg.dev_db.name + "?replicaSet=" + g_cfg.dev_db.setname;

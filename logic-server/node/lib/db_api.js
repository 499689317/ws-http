...
// var Route = {};
// Route.findOne = function (col_name, params) {
//     return function (cb) {
//         var col = g_db.collection(col_name);
//         col.findOne.apply(col, params.concat(function (err,data) {
//             cb(null, err || data);
//         }))
//     }
// }

// Route.updateOne = function (col_name, params) {
//     return function (cb) {
//         var col = g_db.collection(col_name);
//         col.updateOne.apply(col, params.concat(function (err,data) {
//             cb(null, err || data);
//         }))
//     }
// }

// Route.insertOne = function (col_name, params) {
//     return function (cb) {
//         var col = g_db.collection(col_name);
//         col.insertOne.apply(col, params.concat(function (err,data) {
//             cb(null, err || data);
//         }))
//     }
// }

// Route.findOneAndUpdate = function (col_name, params) {
//     return function (cb) {
//         var col = g_db.collection(col_name);
//         col.findOneAndUpdate.apply(col, params.concat(function (err,data) {
//             cb(null, err || data);
//         }))
//     }
// }

// Route.createIndex = function (col_name, params) {
//     return function (cb) {
//         g_db.createIndex.apply(g_db, [col_name].concat(params).concat(function (err,data) {
//             cb(null, err || data);
//         }))
//     }
// }

// Route.findSome = function (col_name, params) {
//     return function (cb) {
//         var col = g_db.collection(col_name);
//         var cursor = col.find(params[0]);
...
//  * @param  {Function}   cb    [完成回调]
//  */
// Route.find = function(coll, where, cb) {
